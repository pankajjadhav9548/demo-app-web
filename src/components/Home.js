      ...
      <div className='container'>
          <h3><center>Featured Products</center></h3><hr/>
            ...
            <div className="card-body">
                <h5 className="card-title"><Link to="/Products">Echo Dot - smart speaker brand in India with Alexa (Black)</Link></h5>
                ...
                <Link to="/Products" className="btn btn-primary">Grab Now ₹1,999</Link>
            </div>
            </div>
            <div className="card col-md-3">
